...
from tradingagents.daily_analysis.formatters import format_feishu_markdown
...
class NotificationService:
    ...
    def _send_feishu_stream_reply(self, chat_id: str, content: str) -> bool:
        ...
        """
        try:
            from tradingagents.daily_analysis.bot.platforms.feishu_stream import FeishuReplyClient, FEISHU_SDK_AVAILABLE
